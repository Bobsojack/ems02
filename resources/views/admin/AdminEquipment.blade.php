                ...
                <div class="search-container">
                    <div class="btn-group">
                        ...
                        <div class="dropdown-menu">
                            <a class="dropdown-item" href="#" onclick="setSearchColumn(1, 'Group of Equipment')">Group of Equipment</a>
                            <a class="dropdown-item" href="#" onclick="setSearchColumn(2, 'Serial No')">Serial No</a>
                            <a class="dropdown-item" href="#" onclick="setSearchColumn(3, 'Name Equipment')">Name Equipment</a>
                            ...
                            <a class="dropdown-item" href="#" onclick="setSearchColumn(6, 'Starting Date')">Starting Date</a>
        ...
        <table id="equipmentTable" class="table table-striped table-bordered">
            ...
            <tbody>
                @foreach ($equipments as $equipment)
                    <tr>
                        <td><input type="checkbox" class="select-checkbox" value="{{ $equipment->id }}"></td>
                        ...
                        <td>
                            <div>
                                <button class="edit-button" onclick="editEquipment({{ $equipment->id }})">Edit</button>
                            </div>
                        </td>
                        <td><button class="delete-button"
                                onclick="deleteEquipment({{ $equipment->id }})">Delete</button></td>
                    </tr>
                @endforeach
            </tbody>
        </table>
