...
<body>
    <div id="card" class="mt-5">
        <h1 class='text'>Edit Equipment</h1>
        <form action="{{ route('equipment.update', $equipment->equipment_id) }}" method="POST">
            @csrf
            @method('PUT')
            <div class="cantainer form-group">
                <label for="GroupofEquipment">Group of Equipment</label>
                <select class="form-control" id="GroupofEquipment" name="GroupofEquipment" required>
                    <option value="{{ $equipment->GroupofEquipment }}" selected>{{ $equipment->GroupofEquipment }}</option>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="NameEquipment" name="NameEquipment"
                    value="{{ $equipment->NameEquipment }}" required>
            </div>
            <div class="form-group">
                <label for="cost">Cost (Baht)</label>
                <input type="number" class="form-control" id="cost" name="cost" value="{{ $equipment->cost }}"
                    required>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="date" class="form-control" id="StartingDate" name="StartingDate"
                    value="{{ $equipment->StartingDate }}" required>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <select class="form-control" id="Company" name="Company" required>
                    <option value="{{ $equipment->Company }}" selected>{{ $equipment->Company }}</option>
            ...
            {{-- <a href="{{ route('upload') }}" class="btn btn-secondary">Cancel</a> --}}
        </form>
    </div>
    <!-- Bootstrap JS -->
